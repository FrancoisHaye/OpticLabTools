...
Package providing necessary utilities to run routines for gaussian defect displacement with a Moglabs RF synthetizer. A Thorlabs scientific camera is also needed.
...
.. autosummary::
    ...
    do_*calibration_from_exp - function to analyze results from a calibration experiment previously launched.
...
from ._mogrf_utilities import Path, Line, Circle, MovePoint
from ._aom_calibration import do_calibration, do_calibration_from_exp, do_quick_calibration